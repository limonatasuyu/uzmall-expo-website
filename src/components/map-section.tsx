...
export function MapSection() {
  ...
  return (
    <section className="flex flex-col items-center justify-center w-screen py-16 bg-[#095d66]">
      <div className="w-[80%] max-w-7xl">
        ...
        <div className="text-center">
          <p className="text-xl text-white mb-2">{t("HomePage.locationSection.address")}</p>
        </div>
      </div>
    </section>
  );
