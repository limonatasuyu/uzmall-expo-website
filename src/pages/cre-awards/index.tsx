        ...
        <div className="relative w-full">
          ...
          <div className="mx-auto px-4 pb-32 relative">
            <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
              ...
              <h1 className="text-4xl font-bold text-[#095d66] mb-12">{t("creAwards.title")}</h1>
              ...
              <div className="backdrop-blur-sm bg-[#eaeaea]/5 rounded-2xl p-8 shadow-2xl border border-white/10 mb-16">
                <div className="space-y-8 text-[#095d66]">
                  <p className="text-xl leading-relaxed font-light">{t("creAwards.description1")}</p>
                  <p className="text-xl leading-relaxed font-light">{t("creAwards.description2")}</p>
                  <p className="text-xl leading-relaxed font-light">{t("creAwards.description3")}</p>
                </div>
              </div>
